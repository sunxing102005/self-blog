<template>
  <div class="login-container">
    <el-form autoComplete="on" status-icon :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left" label-width="0px" class="card-box login-form">
  ...
  export default {
    ...
    data(){
      ...
      const validatePwd = (rule,value,callback)=>{
        if(value.length>6){
          callback(new Error('the length of password must under 6!'))
        }else{
          callback()
        }
      }
